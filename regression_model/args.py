...
def argbuilder():
    ...
    Returns:
        args (Namespace): Parsed arguments including:
            ...
            home_dir (str): The directory where training data, models, and results are stored.
    ...
    parser.add_argument('--feat', type=str, required=True, help='The feature name to be used (e.g., Hf(R)).')
    parser.add_argument('--home_dir', default='/home/fu/NCKU_training/Codes/', type=str, help='Home directory for data, models, and results.')
    ...
    parser.add_argument('--model_arch', type=str, required=True, help='Model architecture (e.g., RR, BRR, KRR, SVR).')
    parser.add_argument('--num_iters', default=50, type=int, help='Number of iterations for hyperparameter optimization.')
    parser.add_argument('--save_dir', default='Codes/', type=str, help='Directory to save models and results.')
    parser.add_argument('--minimize_score', default=True, type=bool, help='Minimize the score (True) or maximize (False).')
    parser.add_argument('--config_save_path', default='/home/fu/NCKU_training/Codes/Hyper', type=str, help='Path to save hyperparameter configurations.')
