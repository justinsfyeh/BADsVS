...
SPACE = {
    ...
    'batch_size':hp.quniform('batch_size',low=8, high=128, q=8),
    'max_lr':hp.loguniform('max_lr',low=-6, high=-2)
}
INT_KEYS = ['hidden_size', 'ffn_num_layers','batch_size']
#'depth',
...
def hyperopt(args: HyperoptArgs) -> None:
    ...
    * :code:`ffn_num_layers`: The number of feed-forward layers after message passing is selected from {1, 2, 3}
    ...
    def objective(hyperparams: Dict[str, Union[int, float]]) -> float:
        ...
        hyper_args.final_lr = hyper_args.max_lr / 500
        hyper_args.init_lr = hyper_args.max_lr / 50
